...
public class Trip implements Serializable {
    ...
    public Trip(String startCity, String endCity, double price, LocalDate startDate, LocalDate endDate, Boolean isSelected, String imageUrl) {
    ...
    public static ArrayList<Trip> createTripsList() {
        ...
        trips.add(new Trip("Miami", "Orlando", 200, LocalDate.of(2022, 05, 10), LocalDate.of(2022, 10, 14), false, "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/04/09/e0/eb/universal-s-islands-of.jpg?w=600&h=400&s=1"));
        trips.add(new Trip("Seville", "Madrid", 400, LocalDate.of(2023, 1, 1), LocalDate.of(2023, 2, 1), false, "https://www.easyjet.com/ejcms/cache/medialibrary/Images/JSS/Destinations/Hero/Spain_Madrid_3840x2160.jpg?mw=1920&hash=E8335D1B8641F2150C395A3EC48BA45CC0B5BA6D"));
