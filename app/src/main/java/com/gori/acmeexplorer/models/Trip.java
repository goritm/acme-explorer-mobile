...
public class Trip implements Serializable {
    ...
    public static ArrayList<Trip> createTripsList() {
        ...
        trips.add(new Trip("Miami", "Orlando", new BigDecimal(200), LocalDate.of(2022, 05, 10), LocalDate.of(2022, 10, 14), false, "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/04/09/e0/eb/universal-s-islands-of.jpg?w=600&h=400&s=1"));
        ...
        trips.add(new Trip("Quito", "Amsterdam", new BigDecimal(500), LocalDate.of(2022, 7, 1), LocalDate.of(2022, 7, 18), false, "https://www.guruwalk.com/blog/wp-content/uploads/2019/10/what-to-do-see-amsterdam.jpg"));
